...
- **What it does** (`scripts/vrp_harvester.py`): sells defined-risk
  ...
  strike is richly priced — **gate v2 (2.9): richness ≥ trailing-252d p90 AND
  ≥ 8% floor** (IV-rank timing, not the retired flat 20%), unless an LLM
  ...
  Watch: daily digest shows realized-vs-predicted (~21%) gate fire-rate.
